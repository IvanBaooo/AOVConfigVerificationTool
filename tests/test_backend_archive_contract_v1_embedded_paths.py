...
class BackendArchiveContractV1EmbeddedPathTests(unittest.TestCase):
	def _report_with_check_item_id(self, value: str) -> dict[str, object]:
	...
	def test_rejects_drive_path_even_when_attached_to_prefix(self) -> None:
		report = self._report_with_check_item_id(r"prefixG:\Branches\secret\skin.dtxml")
	...
	def test_does_not_treat_https_url_as_drive_path(self) -> None:
		payload = build_archive_record(self._report_with_check_item_id("https://example.invalid/skin"))
		self.assertEqual(
