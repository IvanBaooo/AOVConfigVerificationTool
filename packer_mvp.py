...
def load_validation_config(config_path: str) -> Dict[str, object]:
...
def apply_validation_to_report(
	*,
	...
	validation = run_mvp_validations(
	...
	confirm_count = int(summary.get("confirm_count", 0))
	if error_count:
...
def pack_incremental_package_mvp(
	*,
	svn_text: str,
	local_root: str,
	output_parent: str,
	...
	return apply_validation_to_report(
		result=result,
		local_root=local_root,
		svn_text=svn_text,
		validation_config=validation_config,
